    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="card-title">Menu Prepare</h5>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="foto" class="form-label">Foto Menu Prepare</label>
                    ...
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama Menu Prepare</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="xxx" oninput="toTitleCase(this)" required>
                            <span class="input-group-text position-static satuan text-muted">pcs</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <datalist id="barang">
                            <?php foreach ($data['barang'] as $barang) : ?>
                                <?php if ($barang['jenis'] != 'bahan') continue; ?>
