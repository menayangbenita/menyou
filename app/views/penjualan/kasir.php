            ...
            <div class="container-fluid mb-3 kategori-menu <?= strtolower($kategori['nama']) ?>">
                ...
                <div class="row">
                    <?php foreach ($data["menu"] as $menu) : ?>
                        ...
                        >
                            <button class="card w-100 h-100 animation-card addProductSale overflow-hidden position-relative p-0">
                                <div class="row w-100 g-0">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="card-body text-start py-3 text-nowrap h-100">
                                            ...
                                            <h6 class="card-text mb-0 text-md text-<?= ($tersedia > 0) ? 'success' : 'danger' ?>">
            ...
            <div class="card-body">
                <form action="<?= BASEURL ?>/pesanan/insert" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control ps-2" name="nomor_telp" value="" placeholder="08xxx"
                            required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 kode-transaksi" style="display: none;">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control ps-2" id="kode_transaksi" name="kode_transaksi"
                                    value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                                <span class="input input-group-text" id="button-addon1">Rp. </span>
                                <input type="number" class="form-control ps-2" id="bayar" name="bayar" value="0"
                                    min="0">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                                <span class="input input-group-text" id="button-addon1">Rp. </span>
                                <input type="number" class="form-control ps-2" id="kembali" name="kembali" value="0"
                                    min="0" readonly>
                            </div>
                        </div>
                    </div>
