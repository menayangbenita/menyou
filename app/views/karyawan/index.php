                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="nik"><span
                                                class="required">NIK / ID Karyawan</span></label>
                                        <input type="text" class="form-control form-control-solid" name="nik" id="nik"
                                            placeholder="Cth: 0101011708450001" required />
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                            for="gaji_karyawan"><span class="required">Status Pernikahan</span></label>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="level"><span
                                                class="required">Level</span></label>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        ...
                                        <input type="text" name="departement" id="departement"
                                            class="form-control form-control-solid" placeholder="Cth: Kitchen" required>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                            for="atasan_langsung"><span class="required">Atasan Langsung</span></label>
                                        <input type="text" class="form-control form-control-solid"
                                            name="atasan_langsung" id="atasan_langsung" placeholder="Cth: Supervisor"
                                            required>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="mulai"><span
                                                class="required">Mulai Kerja</span></label>
                                        <input class="form-control form-control-solid" type="date" name="mulai_kerja"
                                            id="mulai_kerja" value="<?= date('Y-m-d') ?>" required>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                        ...
                                        <input type="text" class="form-control form-control-solid" name="tempat_lahir"
                                            id="tempat_lahir" placeholder="Cth: Banjarmasin" required>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-8 fv-row">
                                        <div class="col-lg-12">
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                                for="jenis_kelamin"><span class="required">Jenis Kelamin</span></label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                name="jenis_kelamin" id="jenis_kelamin_l" value="Laki-laki" required />
                                            <label class="form-check-label" for="jenis_kelamin_l">Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                name="jenis_kelamin" id="jenis_kelamin_p" value="Perempuan" required />
                                    ...
                                    <div class="mb-8 fv-row">
                                        <div class="col-lg-12">
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                                for="jenis_kelamin"><span class="required">Golongan Darah</span></label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="agama"><span
                                                class="required">Agama</span></label>
                                        <select class="form-select form-select-solid" name="agama" id="agama" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="suku"><span
                                                class="required">Suku</span></label>
                                        <input type="text" class="form-control form-control-solid" name="suku" id="suku"
                                            placeholder="Cth: Dayak" required>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="email"><span
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                            for="masa_ktp"><span class="required">Masa Berlaku KTP/Paspor</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="no_kk"><span
                                                class="required">Nomor Kartu Keluarga</span></label>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="npwp"><span
                                                class="required">NPWP</span></label>
                                        <input type="text" class="form-control form-control-solid" name="npwp" id="npwp"
                                            placeholder="99.999.999.9-999.000" required>
                                    </div>
                                    <div class="mb-8 fv-row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gaji_overtime" id="ot_ya"
                                                value="1" required />
                                    ...
                                    <div class="mb-8 fv-row">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gaji_insentif" id="in_ya"
                                                value="1" required />
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                            for="bpjs_kesehatan"><span class="required">BPJS Kesehatan</span></label>
                                        <input type="text" class="form-control form-control-solid" name="bpjs_kesehatan"
                                            id="bpjs_kesehatan" placeholder="103133911101" required />
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                            for="bpjs_kesehatan_keluarga">BPJS Kesehatan (Istri, Suami, Anak)</label>
                                        <textarea class="form-control form-control-solid" name="bpjs_kesehatan_keluarga"
                                            id="bpjs_kesehatan_keluarga" placeholder="0000591500002"></textarea>
                                    </div>
                                    <div class="mb-8 fv-row">
                                        <div class="col-lg-12">
                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="card border-1 shadow-none">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-column mb-8 fv-row">
                                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2"
                                                    for="gaji_pokok"><span class="required">Gaji Pokok</span></label>
                                                <input type="number" class="form-control form-control-solid"
